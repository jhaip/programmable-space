    ...
    if len(ids) > 0:
        for i, _tag_corners in enumerate(corners):
            ...
            claims.append({"type": "claim", "fact": [
                ...
                ["text", str(ids[i][0])],
                ["text", "at"],
                ["integer", str(round(tag_corners[0][0]))],
                ["integer", str(round(tag_corners[0][1]))],
                ["integer", str(round(tag_corners[1][0]))],
                ["integer", str(round(tag_corners[1][1]))],
                ["integer", str(round(tag_corners[2][0]))],
                ["integer", str(round(tag_corners[2][1]))],
                ["integer", str(round(tag_corners[3][0]))],
                ["integer", str(round(tag_corners[3][1]))],
                ["text", "@"],
