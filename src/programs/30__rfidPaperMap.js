...
room.assert(`paper 1985 has RFID`, ["text", "353ffe3b"])
...
room.assert(`paper 1970 has RFID`, ["text", "45d9ea3b"])
room.assert(`paper 1969 has RFID`, ["text", "c531f53b"])
room.assert(`paper 1968 has RFID`, ["text", "05cbff3b"])

room.assert(`paper 1760 has RFID`, ["text", "cb206c53"])
room.assert(`paper 1761 has RFID`, ["text", "d50ef43b"])
room.assert(`paper 1762 has RFID`, ["text", "5546f913"])
room.assert(`paper 1763 has RFID`, ["text", "50d10140"])
room.assert(`paper 1764 has RFID`, ["text", "755cf03b"])
room.assert(`paper 1765 has RFID`, ["text", "a52dfd3b"])
room.assert(`paper 1766 has RFID`, ["text", "753998e9"])
room.assert(`paper 1767 has RFID`, ["text", "651a57e9"])
room.assert(`paper 1768 has RFID`, ["text", "d51f62e9"])
room.assert(`paper 1769 has RFID`, ["text", "450171e9"])
room.assert(`paper 1770 has RFID`, ["text", "15d88ce9"])
room.assert(`paper 1771 has RFID`, ["text", "753b61e9"])
room.assert(`paper 1772 has RFID`, ["text", "353aa3ca"])
room.assert(`paper 1773 has RFID`, ["text", "85616dcb"])
room.assert(`paper 1774 has RFID`, ["text", "e5daa4ca"])
room.assert(`paper 1775 has RFID`, ["text", "f578b8cd"])
room.assert(`paper 1776 has RFID`, ["text", "7422bc4e"])
room.assert(`paper 1777 has RFID`, ["text", "f540cacd"])
room.assert(`paper 1778 has RFID`, ["text", "b546c5cd"])
room.assert(`paper 1779 has RFID`, ["text", "a548cccd"])
room.assert(`paper 1780 has RFID`, ["text", "541cacd4"])
room.assert(`paper 810 has RFID`, ["text", "d534aecd"])
room.assert(`paper 1625 has RFID`, ["text", "0bbaac52"])
// RFID Keyrings:
room.assert(`paper 1776 has RFID`, ["text", "87192933"])
room.assert(`paper 1777 has RFID`, ["text", "47733633"])
room.assert(`paper 1778 has RFID`, ["text", "57db2134"])
room.assert(`paper 1779 has RFID`, ["text", "a903c5d5"])
room.assert(`paper 1780 has RFID`, ["text", "f7ba0034"])
